...
export default function ProfilePage() {
  ...
  const currentUser = api.members.getMemberInfo.useQuery({
  ...
  useEffect(() => {
    if (currentUser.data) {
      form.setFieldValue(
        "name",
        currentUser.data?.name ?? user?.fullName ?? undefined,
      );
      form.setFieldValue(
        "email",
      ...
      form.setFieldValue(
        "institution",
        currentUser.data?.institution ?? undefined,
      );
  ...
  return (
    <>
      <Container className={"py-5"}>
        ...
        <SectionTitle
          heading="Connect Better, Update Your Profile!"
          description="Adding more details to your profile helps in building stronger connections."
        />

        <form
          onSubmit={form.onSubmit(handleFormSubmit)}
          className={` mx-auto max-w-screen-lg sm:w-[60vw]`}
        >
          ...
          <div className=" mb-4 grid grid-cols-1 gap-2 sm:grid-cols-2">
            <TextInput
              ...
              withAsterisk
              required
              placeholder="e.g UoN / Airtel Kenya"
            />
            <TextInput
          ...
          <Textarea
            ...
            size="md"
            label="About"
            placeholder=" A short description of yourself and  your craft"
            className="mb-4"
          />
          ...
          <div className="my-6 flex justify-center">
            <CustomButton
              ...
              type="submit"
              title={
                updateUserInfo.isLoading ? "Updating..." : "Update Profile"
              }
