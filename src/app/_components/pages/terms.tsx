  ...
  return (
    <Container className="">
      <div className=" mx-auto flex flex-col gap-y-4 py-8">
        ...
        <p className={`${dark ? "text-slate-400" : "text-slate-600"}`}>
          Welcome to Teksade, a community-driven platform connecting tech
          enthusiasts! This Privacy Policy is designed to help you understand
          how we collect, use, and safeguard your personal information. By using
          Teksade, you agree to the terms outlined in this policy.
        </p>
          ...
          subSections={[
            {
              ...
              content: (
                ...
                >
                  ...
                  contact us at{" "}
                  <a
                    href="mailto:contact@teksade.com"
