    ...
    <Container>
      <div className="flex flex-col items-center justify-center gap-y-10 py-5">
        ...
        >
          ...
          skilled developers and designers to contribute to our project. This is
          your chance to collaborate with a team of like-minded individuals and
        ...
        <div className="flex flex-col gap-5 sm:flex-row">
          ...
          <Link
            href="https://twitter.com/teksadehq"
            target="_blank"
            rel="noopener"
          >
            <Button
