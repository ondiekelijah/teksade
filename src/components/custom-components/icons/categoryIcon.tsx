...
const CategoryIcon: React.FC<CategoryIconProps> = ({ className = "", width = 24, height = 24, fill = "none" }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" className="-ml-1 mr-1 text-slate-400 dark:text-slate-500" viewBox="0 0 24 24" stroke="currentColor" fill="none">
