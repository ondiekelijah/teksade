    ...
    <Container>
      <div className="flex flex-col items-center justify-center gap-y-10 p-5">
        ...
        <div className="flex flex-col gap-5 sm:flex-row">
          ...
          target="_blank"
          >
            <Button className="w-full rounded-full sm:w-auto" size="md" leftIcon={<GitHub />}>
              Contribute on Github
            </Button>
          </Link>
          <Link href="https://twitter.com/teksadehq"
          target="_blank"
          >
            <Button variant="outline" className="w-full rounded-full sm:w-auto" size="md" leftIcon={<Twitter />}>
              Follow on Twitter
            </Button>
          </Link>
        </div>
