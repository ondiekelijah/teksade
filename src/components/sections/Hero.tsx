  ...
  return (
    <Container>
      <section className="z-0 flex min-h-max w-full flex-col items-center justify-center gap-y-7 py-20 bg-cover bg-center bg-no-repeat">
        <Title order={1} className="text-center text-4xl font-black tracking-normal sm:text-5xl lg:text-7xl/[90px]" variant="gradient" gradient={{ from: "indigo", to: "cyan", deg: 95 }}>
          Discover the most vibrant and engaged tech communities.
        </Title>

        <Title order={2} className={`mx-auto max-w-full font-normal text-center text-base sm:text-2xl lg:max-w-screen-md ${dark ? "text-slate-400" : "text-slate-600"}`}>
