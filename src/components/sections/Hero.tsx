  ...
  return (
    <Container>
      <section className="z-0 flex min-h-max w-full flex-col items-center justify-center gap-y-7 overflow-hidden bg-cover bg-center bg-no-repeat py-20">
        ...
        <Title order={2} className={`mx-auto max-w-full overflow-hidden text-center text-base font-normal sm:text-2xl lg:max-w-screen-md ${dark ? "text-slate-400" : "text-slate-600"}`}>
