...
const featuredGroups = [
  {
    ...
    images: [
      ...
      {
        id: 1,
        src: "/img/groups/space-ya-tech/space-ya-tech.jpg",
        alt: "image",
        width: 100,
        height: 100,
      },
      {
        id: 2,
        src: "/img/groups/space-ya-tech/space-ya-tech-2.jpg",
        alt: "image",
        width: 100,
        height: 100,
      },
      {
        id: 3,
        src: "/img/groups/space-ya-tech/space-ya-tech-3.jpg",
        alt: "image",
        width: 100,
        height: 100,
      },
  ...
  },
  {
    ...
    images: [
      {
        id: 1,
        src: "/img/groups/lux-tech/lux-tech-1.jpg",
        alt: "image",
        width: 100,
        height: 100,
      },
      {
        id: 2,
        src: "/img/groups/lux-tech/lux-tech-2.jpg",
        alt: "image",
        width: 100,
        height: 100,
      },
      {
        id: 3,
        src: "/img/groups/lux-tech/lux-tech.jpg",
        alt: "image",
        width: 100,
        height: 100,
      },
  ...
  },
  {
    ...
    images: [
      {
        id: 1,
        src: "/img/groups/kotlin254/kot-1.webp",
        alt: "image",
        width: 100,
        height: 100,
      },
      {
        id: 2,
        src: "/img/groups/kotlin254/kot-2.webp",
        alt: "image",
        width: 100,
        height: 100,
      },
...
export const PopularCommunities = () => {
  return (
    ...
    >
      {/* flex flex-wrap-reverse gap-y-24 justify-between mx-auto max-w-screen-xl */}
