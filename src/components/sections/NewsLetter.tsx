...
export default function NewsLetter() {
  return (
    <Container>
      <div className="mx-auto my-10 grid w-full grid-cols-1 gap-3 rounded-lg px-5 py-10 shadow-2xl sm:grid-cols-2">
        <div className=" flex  w-full grow flex-col  justify-center gap-y-4">
          ...
          <p className="text-base sm:text-2xl">We are glad you are here! So why not subscribe today and stay up-to-date on all the latest news and information about what is going on in the tech community?</p>
