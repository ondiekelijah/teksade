    ...
    <Container>
      <div className="mx-auto my-20 grid w-full grid-cols-1 gap-3 rounded-lg px-8 py-10 shadow-2xl sm:grid-cols-2">
        <div className=" flex  w-full grow flex-col  justify-center gap-y-4">
          ...
          <p className={`text-base sm:text-xl ${dark ? "text-slate-400" : "text-slate-600"}`}>We are glad you are here! So why not subscribe today and stay up-to-date on all the latest news and information about what is going on in the tech community?</p>
          <div className=" relative flex w-full items-center">
            <TextInput radius="xl" size="lg" className=" w-full" placeholder="Your email address" />
            <Button className=" absolute right-[3%] z-20 rounded-full" variant="gradient" gradient={{ from: "indigo", to: "cyan", deg: 45 }}>
              Subscribe</Button>
          </div>
        </div>
